...
import { View, Text,StyleSheet,SafeAreaView, Image, Slider } from 'react-native';
       ...
       <SafeAreaView style={{alignSelf:'stretch'}}>
        <View style={{marginHorizontal: 32, marginTop: 32}}>
            <View style={styles.topContainer}>
              ...
              onPress={() => navigation.navigate('Details') } size={20} />
              </NeuMorph>
            <View>
        ...
        <View style ={styles.songArtContainer}>
          <NeuMorph size={300}>
            <Image source ={require('../assets/pinkey.png')} style ={styles.songArt} />
            </NeuMorph>
          </View>
            ...
            <View style ={styles.trackContainer}>
              <View style ={{flexDirection: 'row',justifyContent:'space-between'}}>
                ...
                <View style ={styles.controlsContainer}>
                  <NeuMorph size={50} style={{backgroundColor:'#8AAAFF',borderColor: '#8AAAFF'}}>
